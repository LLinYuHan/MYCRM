                ...
                <div class="span9 with-sidebar">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            echo $form->field($model, 'adminpass')->textInput(['class' => 'form-control']);
                            echo $form->field($model, 'repass')->textInput(['class' => 'form-control']);
                            ?>
                            <?php echo Html::submitButton('修改', ['class' => 'btn btn-primary m-b-10 m-l-5']); ?>
